export const CoustmerEngData = [
  {
    id: 1,
    heading: "The Challenge",
    Question1: "Why MamaMia Hemma?",
    Answer1:
      "The need for our solution stemmed from MamaMia's legacy systems, which were stitched together and suboptimal, resulting in inefficiencies for both caregivers and patients.",
    Answer2:
  ...
  {
    id: 2,
    Question1: "How does MamaMia Hemma work?",
    heading: "The Solution",
    icon: "/Coustmer/icon2.png",
    Answer1:
      "Our platform offers MamaMia's patients the convenience of accessing digital healthcare services from the comfort of their homes through a mobile app. Patients can easily share their comprehensive health backgrounds within the app to schedule consultations with caregivers and seek support.",
  },
];

export const CoustmerSweData = [
  {
    id: 1,
    heading: "Utmaningen",
    Question1: "Varför MamaMia Hemma?",
    Answer1:
      "Behovet av vår lösning härstammade från MamaMias äldre system, som var ihopsydda och suboptimala, vilket resulterade i ineffektivitet för både vårdgivare och patienter.",
    Answer2:
