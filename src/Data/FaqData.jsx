export const FaqEnglishData = [
  ...
  },
  {
    id: 6,
    question:
      "Does PrevHealth offer ongoing support, and how can I contact you?",
    answer:
      "PrevHealth is here to support you whenever you need assistance. You can easily reach us by email, phone call, or text message, ensuring that help is always just a message away, no matter the time of day.",
  },
];
export const FaqSwedishData = [
  {
    id: 1,
    question:
  ...
  },
  {
    ...
    answer:
      "Ja, vårt professionella service och support team fungerar som ditt förlängda team för att anpassa PrevHealth enligt dina behov. Oavsett om du är en liten klinik eller en stor vårdinrättning kan PrevHealth anpassas och integreras sömlöst för att möta dina unika krav. Oavsett om du behöver skräddarsydda funktioner, varumärkesalternativ, integration med befintliga system, anpassade rapporter eller arbetsflöden kan vår plattform anpassas för att möta dina specifika behov.",
  },
  {
    id: 3,
    question: "Hur fungerar PrevHealths prismodel?",
    answer:
      "PrevHealth erbjuder flexibla prismodeller som är anpassade till vårdgivarens behov. Vår prismodell är transparent och baserad på faktorer såsom antal användare, kundspecifika anpassningar och tilläggsfunktioner. Kontakta oss för en diskussion kring dina behov och kostnadsbild.",
  },
  {
    id: 4,
    question: "Har ni referenser för er tjänst i Sverige?",
    answer:
      "Ja! PrevHealth har framgångsrikt samarbetat med MamaMia, en ledande vårdgivare i Sverige, för att digitalisera vårdleveransen. Under det första verksamhetsåret möjliggjorde PrevHealths produktutbud för MamaMia att betjäna över 500 000 patienter, förbättra vårdgivarens produktivitet med fem gånger och minska driftskostnaderna med mer än 40%.",
  },
  {
    id: 5,
    question: "Hur hanterar PrevHealth patientdata?",
    answer:
      "Patientdata lagras säkert inom det land där organisationen verkar och/eller betjänar patienter, vilket säkerställer överensstämmelse med lokala förordningar. Åtkomsten är begränsad till auktoriserade vårdpersonal som är involverade i patientvård och prioriterar dataskydd och säkerhet. Kontakta oss för mer information.",
  },
  {
    id: 6,
    question: "Erjbuder PrevHealth löpande support? Hur når vi er?",
    answer:
      "PrevHealth finns här för att stödja dig när du behöver hjälp. Du kan enkelt nå oss via e-post, telefonsamtal eller sms, vilket säkerställer att hjälp alltid är bara ett meddelande bort, oavsett tid på dygnet.",
  },
];
