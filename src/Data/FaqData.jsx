...
export const FaqSwedishData = [
    ...
    },
    {
        id: 4,
        question:
        "Har du någon framgångshistoria som visar hur PrevHealth har gynnat andra organisationer?",
        answer:
        "Ja! PrevHealth har framgångsrikt samarbetat med MamaMia, en ledande vårdgivare i Sverige, för att digitalisera vårdleveransen. Under det första verksamhetsåret möjliggjorde PrevHealths produktutbud för MamaMia att betjäna över 500 000 patienter, förbättra vårdgivarens produktivitet med fem gånger och minska driftskostnaderna med mer än 40%. Denna framgångshistoria understryker PrevHealths engagemang för att revolutionera vårdleveransen och förbättra patientvårdsresultaten.",
    },
    {
        id: 5,
        question:
    ...
    },
    {
        id: 6,
        question:
        "Erbjuder PrevHealth löpande support, och hur kan jag kontakta dig?",
        answer:
